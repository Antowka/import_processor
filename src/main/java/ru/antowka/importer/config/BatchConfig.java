...
public class BatchConfig {
    ...
    public FlatFileItemReader<File> reader() {
        return new FlatFileItemReaderBuilder<NodeModel>()
                .name("personItemReader")
                .resource(new ClassPathResource("sample-data.csv"))
                .delimited()
                .names(new String[]{"firstName", "lastName"})
                .fieldSetMapper(new BeanWrapperFieldSetMapper<File>() {{
                    setTargetType(NodeModel.class);
                }})
                .build();
    }
    ...
    @Bean
    public ItemWriter<NodeModel> writer() {
        return new JdbcBatchItemWriterBuilder<NodeModel>()
